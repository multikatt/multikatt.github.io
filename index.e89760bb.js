...
})({"kDBCE":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = null;
...
class Game {
    ...
    drawBorder(width = 12, height = 22) {
        ...
        for(let ix = 0; ix < width; ix++){
            for(let iy = 0; iy < height; iy++)if (iy == 0 || iy == height - 1 || ix == 0 || ix == width - 1) border_blocks.push(new Block(ix, iy, "grey"));
        }
...
class Block extends Game {
    ...
    draw() {
        ...
        this.ctx.fillRect(this.pos_x * (this.size + this.margin), this.pos_y * (this.size + this.margin), this.size, this.size);
    }
}
class Tetromino {
    build_tetromino() {
...
},{}]},["kDBCE","ftAGR"], "ftAGR", "parcelRequire685b")
